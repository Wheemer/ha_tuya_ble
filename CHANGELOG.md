...
* **device:** add support for EL605A Knob Lock (jtmspro/2hmqh0ty), index reversed mac addresses ([bd44a70](https://github.com/ha-tuya-ble/ha_tuya_ble/commit/bd44a7011cf5fe13bae1bbddf69718dbff75a4fd))
